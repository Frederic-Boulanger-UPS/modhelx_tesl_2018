...
(	otherlv_0='tag' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getTagRelationAccess().getTagKeyword_0());
    }
	otherlv_1='relation' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getTagRelationAccess().getRelationKeyword_1());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTagRelationAccess().getExprTagExprParserRuleCall_2_0()); 
	    }
...
(
    { 
        newCompositeNode(grammarAccess.getTagExprAccess().getSameTagsExprParserRuleCall_0()); 
    }
    this_SameTagsExpr_0=ruleSameTagsExpr
    { 
        $current = $this_SameTagsExpr_0.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getTagExprAccess().getAffineTagsExprParserRuleCall_1()); 
    }
    this_AffineTagsExpr_1=ruleAffineTagsExpr
    { 
        $current = $this_AffineTagsExpr_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleSameTagsExpr returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSameTagsExprRule()); }
	 iv_ruleSameTagsExpr=ruleSameTagsExpr 
	 { $current=$iv_ruleSameTagsExpr.current; } 
	 EOF 
;

// Rule SameTagsExpr
ruleSameTagsExpr returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getSameTagsExprAccess().getSameTagsExprAction_0(),
            $current);
    }
)(
(
		{
			if ($current==null) {
	            $current = createModelElement(grammarAccess.getSameTagsExprRule());
	        }
        }
	otherlv_1=RULE_ID
	{
		newLeafNode(otherlv_1, grammarAccess.getSameTagsExprAccess().getClockYClockCrossReference_1_0()); 
	}
...
(
		lv_eq_2_0=	'=' 
    {
        newLeafNode(lv_eq_2_0, grammarAccess.getSameTagsExprAccess().getEqEqualsSignKeyword_2_0());
    }
...
(
	...
	otherlv_3=RULE_ID
	{
		newLeafNode(otherlv_3, grammarAccess.getSameTagsExprAccess().getClockXClockCrossReference_3_0()); 
	}
...
entryRuleAffineTagsExpr returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAffineTagsExprRule()); }
	 iv_ruleAffineTagsExpr=ruleAffineTagsExpr 
	 { $current=$iv_ruleAffineTagsExpr.current; } 
	 EOF 
;

// Rule AffineTagsExpr
ruleAffineTagsExpr returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getAffineTagsExprAccess().getAffineTagsExprAction_0(),
            $current);
    }
)(
(
		{
			if ($current==null) {
	            $current = createModelElement(grammarAccess.getAffineTagsExprRule());
	        }
        }
	otherlv_1=RULE_ID
	{
		newLeafNode(otherlv_1, grammarAccess.getAffineTagsExprAccess().getClockYClockCrossReference_1_0()); 
	}
...
(
		lv_eq_2_0=	'=' 
    {
        newLeafNode(lv_eq_2_0, grammarAccess.getAffineTagsExprAccess().getEqEqualsSignKeyword_2_0());
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getAffineTagsExprAccess().getValueAExpressionParserRuleCall_3_0()); 
	    }
		lv_valueA_3_0=ruleExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAffineTagsExprRule());
	        }
       		set(
       			$current, 
       			"valueA",
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getAffineTagsExprAccess().getAsteriskKeyword_4());
    }
(
(
		{
	...
	otherlv_5=RULE_ID
	{
		newLeafNode(otherlv_5, grammarAccess.getAffineTagsExprAccess().getClockXClockCrossReference_5_0()); 
	}

)
)	otherlv_6='+' 
    {
    	newLeafNode(otherlv_6, grammarAccess.getAffineTagsExprAccess().getPlusSignKeyword_6());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getAffineTagsExprAccess().getValueBExpressionParserRuleCall_7_0()); 
	    }
		lv_valueB_7_0=ruleExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAffineTagsExprRule());
	        }
       		set(
