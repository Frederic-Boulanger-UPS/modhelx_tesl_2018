...
public abstract class PlainManagedInterfaceBlock extends ManagedInterfaceBlock {

    public PlainManagedInterfaceBlock(String name, Model<?> model, Object... properties) {
    ...
    public boolean shouldUpdateModel() {
        // By default, always update internal model
        return true;
    }
