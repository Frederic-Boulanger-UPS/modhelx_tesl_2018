...
import static fr.supelec.tesl.lang.tesl.ROUNDING_MODE.*
            ...
            if ("_all_".equalsIgnoreCase(kind)) {
                ...
                for (String name : lets) {
                    ...
                    if (value instanceof IntegerValue) {
                        ...
                        builder.append(name);
                        builder.append(" = ");
                        builder.append((value as IntegerValue).getValue());
                    } else if (value instanceof DecimalValue) {
                        builder.append("decimal ");
                        builder.append(name);
                        builder.append(" = ");
                        builder.append((value as DecimalValue).getValue());
                    } else if (value instanceof FloatValue) {
                        builder.append("float ");
                        builder.append(name);
                        builder.append(" = ");
                        builder.append((value as FloatValue).getValue());
                    } else if (value instanceof RationalValue) {
                        builder.append("rational ");
                        builder.append(name);
                        builder.append(" = ");
                        builder.append((value as RationalValue).getValue());
                    } else {
